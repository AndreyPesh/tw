    ...
    <header className="relative w-full px-5 md:px-20 py-2 md:py-0 flex justify-between items-center border-b border-b-light">
      ...
      <div
        className={classNames(
          'absolute top-[67px] right-0 w-full h-[calc(100vh-67px)] flex flex-col justify-between bg-white md:flex-row md:relative md:top-0 md:h-auto md:w-2/3 duration-200',
          {
            'left-0': active,
            'left-[-100vw]': !active,
          }
